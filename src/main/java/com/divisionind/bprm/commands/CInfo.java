...
public class CInfo extends ACommand {
    ...
    public void execute(CommandSender sender, String label, String[] args) {
        ...
        respondn(sender,
                "&7Fork mantenido por &aenigmoes &7— basado en BackpacksRemastered de drew6017 (Andrew Howard).");
        ...
        respondn(sender,  "&eRepositorio: &ahttps://github.com/enigmoes/BackpacksRemastered");
    }
}